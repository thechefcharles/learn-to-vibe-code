- generic [ref=f2e4]:
  - generic [ref=f2e5]:
    - banner [ref=f2e6]:
      - generic [ref=f2e8]:
        - link "Back to TagVault" [ref=f2e9] [cursor=pointer]:
          - /url: http://localhost:3008/support?cancelled=true
          - generic [ref=f2e11]:
            - img [ref=f2e12]
            - generic [ref=f2e14]: Back
            - generic [ref=f2e16]:
              - img [ref=f2e18]
              - heading "TagVault" [level=1] [ref=f2e20]
        - generic [ref=f2e21]: Sandbox
    - generic [ref=f2e24]:
      - heading "Support Learn to Vibe Code" [level=2] [ref=f2e25]:
        - generic [ref=f2e27]: Support Learn to Vibe Code
      - generic [ref=f2e29]:
        - generic [ref=f2e32]: $5.00
        - generic [ref=f2e40]: Your donation helps keep the course free and accessible.
  - generic [ref=f2e41]:
    - main [ref=f2e42]:
      - generic [ref=f2e45]:
        - generic [ref=f2e277]:
          - iframe [ref=f2e51]:
            - generic [ref=f6e6]:
              - iframe [ref=f6e11]:
                - button "Apple Pay" [ref=f11e5] [cursor=pointer]:
                  - img [ref=f11e7]:
                    - img "Apple Logo" [ref=f11e8]
              - button "Pay with Link" [ref=f6e14] [cursor=pointer]:
                - img [ref=f6e17]
          - generic [ref=f2e52]:
            - separator [ref=f2e53]
            - paragraph [ref=f2e54]: Or
        - heading "Contact information" [level=2] [ref=f2e55]
      - generic [ref=f2e59]:
        - generic [ref=f2e60]:
          - generic [ref=f2e62]:
            - generic [ref=f2e64]: Email
            - textbox "Email" [ref=f2e71]:
              - /placeholder: email@example.com
              - text: test@example.com
          - heading "Payment method" [level=2] [ref=f2e73]
        - generic [ref=f2e74]:
          - list [ref=f2e75]:
            - listitem [ref=f2e80]:
              - generic [ref=f2e81]:
                - generic [ref=f2e89]:
                  - generic [ref=f2e93]:
                    - radio "Card" [checked] [ref=f2e94]
                    - generic [ref=f2e96]: Card
                  - generic:
                    - button "Pay with card"
                - generic [ref=f2e102]:
                  - generic [ref=f2e104]:
                    - generic [ref=f2e106]: Card information
                    - group [ref=f2e107]:
                      - generic [ref=f2e108]:
                        - generic [ref=f2e110]:
                          - textbox "Card number" [ref=f2e113]:
                            - /placeholder: 1234 1234 1234 1234
                            - text: 4242 4242 4242 4242
                          - generic:
                            - img "Visa"
                        - textbox "Expiration" [active] [ref=f2e118]:
                          - /placeholder: MM / YY
                          - text: 12 / 28
                        - generic [ref=f2e120]:
                          - textbox "CVC" [ref=f2e123]: "123"
                          - generic:
                            - generic:
                              - img "Credit or debit card CVC"
                        - generic:
                          - generic: Your card’s expiration year is in the past.
                  - group "Billing address" [ref=f2e129]:
                    - generic [ref=f2e130]:
                      - generic [ref=f2e132]:
                        - generic [ref=f2e134]: Cardholder name
                        - textbox "Cardholder name" [ref=f2e141]:
                          - /placeholder: Full name on card
                          - text: Test User
                      - generic [ref=f2e143]:
                        - generic [ref=f2e145]: Country or region
                        - group [ref=f2e146]:
                          - generic [ref=f2e147]:
                            - generic [ref=f2e151]:
                              - combobox "Country or region" [ref=f2e152]:
                                - option "Afghanistan"
                                ...
                                - option "Zimbabwe"
                              - img
                            - textbox "ZIP" [ref=f2e157]: "12345"
            - listitem [ref=f2e162]:
              - generic [ref=f2e171]:
                - generic [ref=f2e175]:
                  - radio "Bank" [ref=f2e176]
                  - generic [ref=f2e178]: Bank
                - generic:
                  - button "Pay with Bank"
            - listitem [ref=f2e183]:
              - generic [ref=f2e192]:
                - generic [ref=f2e196]:
                  - radio "Klarna" [ref=f2e197]
                  - generic [ref=f2e199]: Klarna
                  - generic [ref=f2e200]: Powered by Link
                - generic:
                  - button "Pay with Klarna"
          - generic [ref=f2e209]:
            - generic [ref=f2e213]:
              - generic [ref=f2e214]:
                - checkbox "Save my information for faster checkout" [checked] [ref=f2e215] [cursor=pointer]
                - generic:
                  - img
              - generic [ref=f2e216]:
                - generic [ref=f2e219] [cursor=pointer]: Save my information for faster checkout
                - generic [ref=f2e221]: Pay securely at TagVault and everywhere Link is accepted.
            - generic [ref=f2e227]:
              - generic [ref=f2e229]: Phone number
              - generic [ref=f2e231]:
                - generic:
                  - generic:
                    - generic:
                      - img "US"
                    - combobox "Phone number country code" [ref=f2e232]:
                      ...
                      - option "Zimbabwe (+263)"
                    - img
                - textbox "Phone number" [ref=f2e234]:
                  - /placeholder: (201) 555-0123
        - generic [ref=f2e236]:
          - button "Pay" [ref=f2e239] [cursor=pointer]:
            - generic:
              - generic [ref=f2e241]: Pay
              - generic [ref=f2e242]: Processing
            - img [ref=f2e247]
            - img [ref=f2e252]
          - generic [ref=f2e261]:
            ...
            - text: .
      - generic [ref=f2e264]:
        - checkbox "I am an AI agent acting on behalf of someone else" [ref=f2e265]
        - text: I am an AI agent acting on behalf of someone else
    - contentinfo [ref=f2e267]:
      - link "Powered by Stripe" [ref=f2e269] [cursor=pointer]:
        - /url: https://stripe.com
        - generic [ref=f2e270]:
          - text: Powered by
          - img "Stripe" [ref=f2e272]
      - link "Terms" [ref=f2e275] [cursor=pointer]:
        - /url: https://stripe.com/legal/end-users
      - link "Privacy" [ref=f2e276] [cursor=pointer]:
