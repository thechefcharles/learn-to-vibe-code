    ...
    <section className="py-16 px-4 bg-gradient-to-b from-white to-slate-50">
      <div className="max-w-6xl mx-auto">
        <motion.h2
          ...
          className="text-4xl font-bold font-display text-ink text-center mb-12"
        >
          What You Get
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, idx) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="bg-white rounded-xl p-8 border-2 border-violet-light/20 hover:border-violet-600 hover:shadow-xl transition-all duration-300 cursor-pointer group"
            >
              <div className="text-5xl mb-4 group-hover:scale-110 transition-transform">{feature.icon}</div>
              <h3 className="text-xl font-bold font-display text-ink mb-2">{feature.title}</h3>
