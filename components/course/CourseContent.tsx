  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        {/* Navigation */}
        <div className="flex justify-between items-start mb-6 gap-6 bg-slate-900/40 backdrop-blur-sm p-5 rounded-lg border border-slate-700/40">
          <div>
            <h1 className="text-4xl font-bold mb-1 text-white drop-shadow-lg">
        ...
        {/* Info Box */}
        <div className="mt-6 p-4 rounded-lg bg-slate-900/60 border border-slate-700/40 backdrop-blur-sm">
          <h3 className="text-sm font-bold text-white mb-1 drop-shadow-md">
            {isKids ? "🎮 What You'll Learn" : "About This Course"}
          </h3>
          <p className="text-xs text-slate-100 drop-shadow-md">
            {isKids
