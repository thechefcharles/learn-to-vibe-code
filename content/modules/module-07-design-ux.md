...
4. **Prototype design-first** with an AI design-to-code tool (e.g. Claude Design — emerging; verify availability) and hand the result off to code. *(Apply)*
...
## Lesson 7.1 — Why AI UIs look generic (~30 min)
...
[SCREENSHOT: Plain, unstyled /clients page an AI builds with no design direction — default system font, cramped spacing, flat hierarchy, no accent color ("before")]

[SCREENSHOT: Plain, unstyled /invoices page — the same generic AI defaults, no visual hierarchy ("before")]

> *Note: the source mislabeled these figures `m06-*`; they belong to Module 7, not Module 6.*
...
You're going to learn the four levers that transform "plain" into "professional" (Lesson 7.2). Then you'll apply them using a component library and Claude Code (Lesson 7.4).

The transformation is the most motivating moment in the course. Same data, same structure, completely different vibe.

---

## Lesson 7.2 — The four levers: hierarchy, spacing, typography, color (~60 min)
...
## Lesson 7.3 — Component libraries: shadcn/ui (~60 min)
...
Why a library beats hand-styling for beginners: consistency for free, accessibility built in (previews Module 13), a professional baseline you can theme, and it drops real code into your repo — so it pairs with Cursor/Claude Code editing. (Theming/dark mode is a natural next step shadcn supports.)

---

[SCREENSHOT: shadcn/ui components — Button, Input, Table, and Card shown in the invoice tracker, giving a polished, accessible baseline]

---

## Lesson 7.4 — Apply design direction with Claude Code (~75 min)
...
- Typography: Use Geist (Next.js's default font) — Inter is an optional opt-in (a Google font), not the default; 3 size tiers max
...
[SCREENSHOT: Restyled "after" — plain /clients (left) beside the restyled version (right) showing hierarchy, consistent spacing, professional typography, and an accent color; desktop plus a 375px mobile view demonstrating responsive stacking]

---

## Lesson 7.4b — Learning from competitors: Screenshot reference design extraction (~60 min)
...
Once you've analyzed, turn it into a design prompt for Claude Code. **Don't describe it in prose — use the pattern from Lesson 7.4 (design direction).**
...
## Lesson 7.5 — Responsive: does it work on a phone? (~30 min)
...
[SCREENSHOT: Responsive mobile view — restyled /clients at desktop width (left) and ~375px mobile width (right), showing the table stacking to a card layout, readable tap targets, and no horizontal scroll]

---

## Lesson 7.6 — Critique and fix "AI-looking" UI (~45 min)
...
## Lesson 7.7 — Design-first AI design-to-code tools (~40 min)

Everything above is *code-first*: you style in the editor with Tailwind/shadcn, which stays the course's default. There's also a *design-first* path worth knowing — sketch and prototype the UI in an AI design tool, then hand it to code. One emerging option is **Claude Design** (an AI design-to-code tool — verify current availability, as this space moves fast); it's a tool in your kit, not a required part of the workflow.
...
[SCREENSHOT: AI design-to-code tool prototype (e.g. Claude Design) — a home screen prompting "What will you design today?" alongside a canvas showing a generated UI prototype (dashboard, form, or flow), illustrating the design-first workflow]
...
- Typography: Geist (Next.js default) — or opt into Inter — 3 sizes max
...
**Q7-1:** Why do AI-generated UIs look generic?
...
**Q7-2:** Which is NOT one of the four design levers?
- (a) hierarchy
- (b) spacing
- (c) **database indexing** ✓
- (d) typography
...
**Q7-3:** shadcn/ui is notable because:
...
**Q7-4:** What's the benefit of design-first prototyping (e.g. with an AI design-to-code tool such as Claude Design) before coding?
...
**Objective 1 — Apply design principles (Quiz Q7-1, Q7-2):**
- Q7-1: Tests hierarchy/spacing/typography knowledge
- Q7-2: Tests responsive design understanding
...
**Objective 2 — Use component library (Quiz Q7-3):**
- Q7-3: "shadcn/ui installs component code..." ✅ Tests library understanding
...
**Objective 3 — Critique & fix (Lesson 7.6 knowledge):**
...
**Objective 4 — Design-first tools (Q7-4):**
- Q7-4: "What's the benefit of design-first prototyping?" ✅ Tests Claude Design/design-first approach understanding
